...
public class WXPay {
     ...
     * @throws Exception
     */
    public Map<String, String> receiveOrder(Map<String, String> reqData) throws Exception {
        return this.receiveOrder(reqData, config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
     ...
     * @throws Exception
     */
    public Map<String, String> receiveOrder(Map<String, String> reqData,  int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WXPayConstants.SANDBOX_RECEIVEORDER_URL_SUFFIX;
        }
        else {
            url = WXPayConstants.RECEIVEORDER_URL_SUFFIX;
        }
